...
struct ContentView: View {
    ...
    @State var cardViews: [CardView] = {
        var views = [CardView]()
        for index in 0..<2 {
            views.append(CardView(VayK: VayKData[index]))
        }
        return views
    }()
    ...
    private func moveCards() {
        ...
        let VayK = VayKData[lastCardIndex % VayKData.count]
        
        let newCardView = CardView(VayK: VayK)
    ...
    var body: some View {
                    ...
                    cardView in cardView
                        ...
                        default:
                            break
                                    ...
                                    .onEnded({ (value) in guard case .second(true, let drag?) = value else {
                                        return
                                    }
        ...
        .alert(isPresented: $showAlert) {
            Alert(
                title: Text("SUCCESS"),
                message: Text("Wishing you a lovely and most memorable vacation."),
                dismissButton: .default(Text("Happy Vaction!")))
        }
    }
}
